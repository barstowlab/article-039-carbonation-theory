...
def Magnesium_Rate(data):
    ...
    if found_equilibrium:
        ...
        print(f'Equilibrium Concentration: {final_concentration}')
    else:
    ...
    #fig.savefig("Figure SVG/100 mM NaOH + CO2 Bubbling at 100°C.svg", bbox_inches="tight", edgecolor="black", format="svg")
...
def plot_bar_graph(file_path, y_label='Y Variable'):
    ...
    # Save file as SVG; change file name for different runs
    #plt.savefig("Figure SVG/Carbonation Percentage with NaOH + CO2 Bubbling.svg", bbox_inches="tight", edgecolor="black", format="svg")
