...
def Time_Series(PestControl):
    ...
    volume3.columns = ['Column1', 'Column2', 'Column3', 'Column4', 'Column5']
    ...
    plt.annotate('CO2 Bubbling', xy=(0.2, co2_bubble_concentration), xytext=(0.3, co2_bubble_concentration + 0.002),
    ...
    plt.annotate('CO2 Bubbling', xy=(0.2, co2_bubble_concentration), xytext=(0.3, co2_bubble_concentration + 1),
             arrowprops=dict(facecolor='black', arrowstyle='->'))
...
def Magnesium_Rate(data):
    ...
    # Combine legends
    lines = [line1, line2, line3, vertical_line]  # Add the vertical line to the list
    labels = [line.get_label() for line in lines]
    fig.legend(lines, labels, loc="upper right", bbox_to_anchor=(1.16, 0.93), title="Legend", facecolor="white")
    ...
    fig.savefig("No Treatment at 100°C.svg", bbox_inches="tight", edgecolor="black", format="svg")
...
def plot_bar_graph(file_path, y_label='Y Variable'):
    ...
    # Save the figure as PDF with high dpi (300)
    # Alter the name of the file based on what you are doing 
    #plt.savefig("No Treatment Carbonation Percentage.svg", bbox_inches="tight", edgecolor="black", format="svg")
